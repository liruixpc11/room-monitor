...
ssh root@115.28.100.161 "rm -rf /opt/room-monitor; mkdir /opt/room-monitor/"
scp dist/room-monitor.tar.gz root@115.28.100.161:/opt/room-monitor/
ssh root@115.28.100.161 "cd /opt/room-monitor/; tar xvf room-monitor.tar.gz; rm room-monitor.tar.gz; mkdir /var/room-monitor/"
